#!/bin/bash
# Upload servo sweep test to DFRobot Beetle

set -e

ARDUINO_CLI=".pixi/bin/arduino-cli"
CONFIG_FILE=".arduino15/arduino-cli.yaml"
SKETCH_DIR="arduino/servo_sweep_test"

echo "Servo Sweep Test - Arduino Upload"
echo "=================================="
echo ""
...
echo ""
echo "Sweep test will run automatically."
echo "To monitor: pixi run sweep-monitor"
